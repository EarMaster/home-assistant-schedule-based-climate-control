...
Alternatively, you can import this specific version: [🔗 Import version v1.1.3](https://my.home-assistant.io/redirect/blueprint_import/?blueprint_url=https%3A//github.com/EarMaster/home-assistant-schedule-based-climate-control/blob/v1.1.3/schedule_based_climate_control.yaml)
